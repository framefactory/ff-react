...
export default class ManipSource
{
    ...
    setListener(listener: IManipListener)
    {
    ...
    protected onManipUpdate(event: IManipEvent)
    {
    ...
    protected onManipEnd(event: IManipEvent)
    {
    ...
    protected onManipEvent(event: IManipEvent)
    {
